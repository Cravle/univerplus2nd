...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Text = L"Таблица Результат";
			...
			this->label2->Text = L"База данных \"Библиотека\"";
			// 
			// button2
			// 
			...
			this->button2->Text = L"Таблица Герой";
			...
			this->button3->Text = L"Таблица Книга";
			...
			this->button4->Text = L"Таблица Издательство";
			...
			this->button6->Text = L"Информация о Книге";
			...
			this->Text = L"База данных \"Библиотека\"";
