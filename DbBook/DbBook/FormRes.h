...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// Column2
			// 
			this->Column2->HeaderText = L"Герой id";
			...
			// Column3
			// 
			this->Column3->HeaderText = L"Книга id";
			...
			this->label2->Text = L"Издательство Id";
			// 
			// label1
			// 
			...
			this->label1->Text = L"Добавить запись";
			// 
			// button3
			// 
